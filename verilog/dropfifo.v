...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/lab3_3/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_8 (.A(XLXN_19[7:0]), 
                                  .B(XLXN_10[7:0]), 
                                  .EQ(XLXN_12));
   // synthesis attribute HU_SET of XLXI_8 is "XLXI_8_18"
   COMP8_MXILINX_dropfifo XLXI_9 (.A(XLXN_10[7:0]), 
                                  .B(XLXN_22[7:0]), 
                                  .EQ(XLXN_13));
   ...
   OR2 XLXI_19 (.I0(XLXN_3), 
                .I1(XLXN_1), 
                .O(XLXN_4));
   AND2B1 XLXI_20 (.I0(XLXN_24), 
                   .I1(XLXN_4), 
                   .O(XLXN_5));
   AND3B2 XLXI_21 (.I0(XLXN_13), 
                   .I1(XLXN_12), 
                   .I2(fiforead), 
                   .O(XLXN_14));
   ...
   dualportmem XLXI_23 (.addra(XLXN_19[7:0]), 
                        .addrb(XLXN_10[7:0]), 
                        .clka(clk), 
                        .clkb(clk), 
                        .dina(XLXN_9[71:0]), 
